...
object PropertiesMagicTypeFeature {
    val descriptor = MagicTypeFeatureDescriptor(
        id = "properties",
        displayName = "Properties<T>",
        summary = "Treats Properties<T> as an array-like shape keyed by fields on class T.",
        capabilities = setOf(
        ...
        supportedContexts = listOf(
            ...
            "Array literals assigned to Properties<T>-annotated locals",
            "Array literals returned from Properties<T>-annotated functions",
            "Array literals passed to Properties<T>-annotated parameters",
        ),
        unsupportedContexts = listOf(
            "Nested utility types such as Pick<Properties<T>, ...>",
            "Object property access semantics on Properties<T>",
